...
@Component({
  selector: 'app-verpedidodomicilio',
  templateUrl: './verpedidodomicilio.component.html',
  styleUrls: ['./verpedidodomicilio.component.css']
})
export class VerpedidodomicilioComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<VerpedidodomicilioComponent>,
